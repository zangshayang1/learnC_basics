...
char* all_tests() {
  ...
  mu_run_test(test_remove); // test order matters here.
  mu_run_test(test_shift);
  mu_run_test(test_destroy); // TODO use of empty list for test clear is not effective
